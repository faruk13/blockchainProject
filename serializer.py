...
def serializeExpensesOnMediaAd(tu):
    dictStruct = {
        'expenses_media_ad': [
            {
                'state': x[0],
...
def serializeExpensesOnPublicityMaterial(tu):
    dictStruct = {
...
def serializeExpensesOnPublicMeetings(tu):
    dictStruct = {
...
def serializeTravelExpensesStarCampaigners(tu):
    dictStruct = {
        'travel_expenses': [
            {
                'id': x[0],
